...
#ifndef __SIGNALSANDGATEWAYS_CANSOURCEGATEWAYAPPBASE_H_
#define __SIGNALSANDGATEWAYS_CANSOURCEGATEWAYAPPBASE_H_

#include <omnetpp.h>
#include <string.h>
#include "buffer/can/Buffer.h"


/**
 * TODO - Generated class
 */
class CanSourceGatewayAppBase : public cSimpleModule
{
protected:
    /**
